...
export default function PreviewPage() {
  ...
  const entries = [
    { id: "00000000-0000-4000-8000-000000000201", status: "posted", entry_type: "deposit", amount_minor: 300000, currency: "USD", occurred_at: "2026-09-01", created_at: at("2026-09-01", "09:00"), title: "A 九月共同存入", payer_member_id: A },
    { id: "00000000-0000-4000-8000-000000000202", status: "posted", entry_type: "deposit", amount_minor: 300000, currency: "USD", occurred_at: "2026-09-01", created_at: at("2026-09-01", "09:01"), title: "B 九月共同存入", payer_member_id: B },
  ...
  return <PreviewClient entries={entries} proposals={proposals} investments={investments} valuations={valuations} members={members}/>;
}
