...
function Ledger({ entries, currency, members }: { entries: Row[]; currency: string; members: Row[] }) {
  return <div className="overflow-hidden rounded-2xl border bg-white">{entries.length ? entries.map((entry) => {
